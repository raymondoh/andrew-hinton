...
<body <?php body_class(); ?>>
    ...
    <header x-data="{ atTop: true }" @scroll.window="atTop = (window.scrollY > 10) ? false : true" id="masthead"
        class="site-header fixed top-0 left-0 right-0 z-40 transition-colors duration-300" :class="{


   'bg-accent': atTop,
   'shadow-lg bg-accent/95 backdrop-blur-sm': !atTop
  }">
    ...
    <main id="main" class="site‑main bg‑light pb‑16 md:pb‑24">